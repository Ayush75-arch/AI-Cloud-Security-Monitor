...
FINDINGS_RAW = [
    ...
    },
    {
        ...
        "ai_attack": "An attacker exploits a known RDS vulnerability patched in a minor version update, gaining unauthorized access to the database before the manual upgrade is performed.",
    ...
    # Lambda
    {
        ...
        "ai_attack": "An attacker exploits a known CVE in Python 3.8 to gain code execution in the Lambda environment, then uses the IAM role attached to the function to move laterally.",
    ...
    },
    {
        ...
        "ai_attack": "A long-running Lambda is exploited to maintain a persistent presence; the extended timeout gives the attacker ample execution time to exfiltrate data from connected services.",
    ...
    },
    {
        ...
        "ai_attack": "After compromising the CloudTrail S3 bucket, the attacker deletes or alters log entries to cover their tracks. Without validation, there is no way to prove tampering occurred.",
    ...
    },
    {
        ...
        "ai_attack": "An attacker with S3 bucket access reads CloudTrail logs without needing to decrypt KMS keys, revealing API activity patterns and potential weaknesses.",
    ...
    },
    {
        ...
        "ai_attack": "An attacker disables a KMS key as part of a ransomware attack, causing dependent services to fail and forcing the organization into a panic state.",
    ...
    },
    {
        ...
        "ai_attack": "Without customer-managed KMS keys, the organization lacks visibility into key usage and cannot enforce granular access policies, making key compromise harder to detect.",
