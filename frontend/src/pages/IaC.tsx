...
export default function IaCPage() {
  ...
  const handleAskAI = (f: IaCFinding) => {
    navigate('/chat', {
      state: {
        findingContext: {
          rule_id: f.rule_id,
          ...
          severity: f.severity,
          asset_name: `${f.resource_type}.${f.resource_name}`,
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="font-mono text-2xs uppercase tracking-widest text-accent-green border border-accent-muted px-2 py-1 hover:bg-accent-muted transition-colors"
                    >
                      ◈ Ask AI
                    </button>
